...
<body>
  ...
  echo "<tr><td colspan='2'>Pencarian</td><td colspan='7'><input type='text' name='cari' size='15'><input type='submit' name='tombol' value='CARI'>&nbsp;&nbsp;<input type=\"button\" onclick=\"location.href='" . $_SERVER['PHP_SELF'] . "?aksi=tambah';\" value=\"TAMBAH\" />&nbsp;&nbsp;<input type=\"button\" onclick=\"location.href='" . $_SERVER['PHP_SELF'] . "';\" value=\"NORMAL\" /></td></tr>";  //proses pencarian data berjalan dengan benar
  echo "</form>";
